...
<div class="container-sm card p-4">
    <form action="{{ url('/admin/change_info') }}" method="post" id="changePasswordForm">
        @csrf
        @method('put')

        <h1 class="text-center">Thay đổi thông tin của {{ auth()->guard('moderator')->user()->username }}</h1>
        ...
        <div class="mb-3">
            ...
            <input type="email" class="form-control" 
                    id="email" placeholder="Nhập email mới" name="email" value="{{ auth()->guard('moderator')->user()->email }}">
