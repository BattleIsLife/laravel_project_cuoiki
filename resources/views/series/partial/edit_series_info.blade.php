    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            <div class="container-sm card p-4 mt-2">
                <form action="{{ url('/author/edit_series', $series->id) }}" method="post" id="seriesForm"  enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <input type="text" class="form-control" 
                                id="series_name" placeholder="Nhập tên series" name="series_name" value="{{ $series->series_name }}">
                        <div class="invalid-feedback" id="series_name_Error"></div>
                    </div>

                    <div class="mb-3">
                        <label for="series_description" class="form-label">Mô tả series:</label>
                        <textarea class="form-control" id="series_description" name="description" rows="5" placeholder="Nhập mô tả series">{{ $series->description }}</textarea>
                    </div>
